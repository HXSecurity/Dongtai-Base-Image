...
CREATE TABLE `iast_project_version`  (
  ...
  `version_name` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '版本号名称',
  `project_id` int(11) NULL DEFAULT NULL COMMENT '项目ID',
  `current_version` tinyint(4) NULL DEFAULT 0 COMMENT '1当前版本0预备版本',
  `description` text CHARACTER SET utf8mb4  NULL COMMENT '版本描述',
...
CREATE TABLE `iast_agent_method_pool_replay`  (
  ...
  `url` varchar(2000) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT 'URL',
  `uri` varchar(2000) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT 'URI',
  `http_method` varchar(10) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT 'HTTP请求方法',
  `http_scheme` varchar(20) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '协议',
  `http_protocol` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT 'HTTP协议',
  `req_header` varchar(2000) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '请求头',
  `req_params` varchar(2000) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '请求参数',
  `req_data` varchar(4000) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '请求体',
  `res_header` varchar(1000) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '响应头',
  `res_body` varchar(1000) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '响应体',
  `context_path` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '应用上下文',
  `language` varchar(20) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '语言',
  `method_pool` json NULL COMMENT '方法池',
  `clent_ip` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '客户端IP',
  `create_time` int(11) NULL DEFAULT NULL COMMENT '创建时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=259782 DEFAULT CHARSET=utf8mb4 COMMENT='æ¼æ´žä¿¡æ¯è¡¨';
...
DROP TABLE IF EXISTS `sca2_package`;
CREATE TABLE `sca2_package` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aql` varchar(255) DEFAULT NULL,
  `hash` varchar(255) DEFAULT NULL,
  `ecosystem` varchar(50) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=27080919 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `sca2_package_dependency` (
  ...
  `p_version` varchar(64) NOT NULL COMMENT '组件版本',
  `dependency_package_name` varchar(255) NOT NULL COMMENT '依赖组件name',
  `d_version` varchar(64) NOT NULL COMMENT '依赖组件版本',
...
DROP TABLE IF EXISTS `sca2_package_repo_dependency`;
CREATE TABLE `sca2_package_repo_dependency` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增id',
  `repo_aql` varchar(255) DEFAULT NULL COMMENT '仓库aql关联',
  `dependency_aql` varchar(255) DEFAULT NULL COMMENT '仓库依赖aql关联',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `sca2_package_repo_dependency_2_repo_aql_IDX` (`repo_aql`,`dependency_aql`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `sca2_vul`;
CREATE TABLE `sca2_vul` (
...
DROP TABLE IF EXISTS `sca2_vul_package`;
CREATE TABLE `sca2_vul_package` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vul_id` varchar(50) DEFAULT NULL,
  `ecosystem` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  `cwe_ids` json DEFAULT NULL,
  `ghsa` varchar(255) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=6536 DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `sca2_vul_package_range`;
CREATE TABLE `sca2_vul_package_range` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vul_package_id` int(11) DEFAULT NULL,
  `ecosystem` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
  `type` varchar(50) DEFAULT NULL,
  `introduced` varchar(50) DEFAULT NULL,
  `introduced_vcode` varchar(50) DEFAULT NULL,
  `fixed` varchar(50) DEFAULT NULL,
  `fixed_vcode` varchar(50) DEFAULT NULL,
  `created_at` datetime(6) DEFAULT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `e_name` (`ecosystem`,`name`),
  KEY `vcode` (`introduced_vcode`,`fixed_vcode`)
) ENGINE=InnoDB AUTO_INCREMENT=6253 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `sca2_vul_package_v2` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `e_name` (`ecosystem`,`name`) USING BTREE,
  KEY `vcode` (`introduced_vcode`,`fixed_vcode`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=218202 DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `sca2_vul_package_version`;
CREATE TABLE `sca2_vul_package_version` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vul_package_id` int(11) DEFAULT NULL,
  `ecosystem` varchar(255) DEFAULT NULL,
  `name` varchar(255) DEFAULT NULL,
...
CREATE TABLE `sca_maven_db` (
  ...
  `import_from` int(11) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `sha_1` (`sha_1`) USING BTREE
...
CREATE TABLE `iast_strategy_user`  (
  ...
  UNIQUE INDEX `id`(`id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 391 ;

INSERT IGNORE INTO `iast_strategy_user` VALUES (5, '插桩测试标准模板', '1,2,3,4,5,6,7,8,16,18,20,21,25,27,14,26,9,10,11,12,13,15,17,19,22,23,24', 1, 1, '2020-12-16 21:32:34');
...
INSERT IGNORE INTO `iast_vul_level` VALUES (1, 'high', '高危', '高危漏洞', 'HIGH', '高危漏洞', 'HIGH', '高危'), (2, 'medium', '中危', '中危漏洞', 'MEDIUM', '中危漏洞', 'MEDIUM', '中危'), (3, 'low', '低危', '低危漏洞', 'LOW', '低危漏洞', 'LOW', '低危'), (4, 'info', '无风险', '提示信息', 'NOTE', '提示信息', 'NOTE', '无风险');
...
) ENGINE = InnoDB AUTO_INCREMENT = 39499 ;
...
) ENGINE = InnoDB AUTO_INCREMENT = 66971721 ;
...
) ENGINE = InnoDB AUTO_INCREMENT = 193562 ;
...
) ENGINE = InnoDB AUTO_INCREMENT = 31963 ;
