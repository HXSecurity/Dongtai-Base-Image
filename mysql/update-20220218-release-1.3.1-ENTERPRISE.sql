...
WHERE title='Java Agent快速部署' AND `language`='JAVA';
UPDATE iast_document
...
WHERE title='Java Agent Release Note' AND `language`='JAVA';
UPDATE iast_document
...
WHERE  title='常见问题(FAQ)' AND `language`='JAVA';
UPDATE iast_document
...
WHERE title='DongTai探针参数配置' AND `language`='JAVA';
UPDATE iast_document
...
WHERE title='DongTai探针参数配置' AND  `language`='PYTHON';
UPDATE iast_document
...
WHERE title='常见问题(FAQ)' AND  `language`='PYTHON';
UPDATE iast_document
...
WHERE title='Python Agent快速部署' AND  `language`='PYTHON';
UPDATE iast_document
...
WHERE title='Python Agent Release Note' AND  `language`='PYTHON';
UPDATE iast_document
...
WHERE title='PHP Agent快速部署' AND `language`='PHP';
