...
ALTER TABLE `iast_agent` ADD COLUMN `language` varchar(10) CHARACTER SET utf8mb4  NULL DEFAULT 'JAVA' COMMENT '语言，JAVA、PYTHON' AFTER `is_core_running`;
...
ALTER TABLE `iast_server` ADD COLUMN `network` text CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '网络情况' AFTER `update_time`;
...
ALTER TABLE `iast_agent_method_pool` ADD COLUMN `req_header_for_search` text CHARACTER SET utf8mb4  NULL COMMENT '用于搜索功能的请求头，请求方法、uri、参数、协议、请求头的拼接' AFTER `pool_sign`;
...
CREATE TABLE IF NOT EXISTS `iast_document`  (
  ...
  `language` varchar(100) CHARACTER SET utf8mb4  NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1  ROW_FORMAT = Dynamic;
